...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Concierge Auto Suite — Plataforma omnichannel para concessionárias" },
      ...
      { property: "og:title", content: "Concierge Auto Suite" },
      { property: "og:description", content: "Plataforma omnichannel premium para concessionárias." },
